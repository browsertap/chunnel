  ...
  Server = (function() {
    ...
    */
    ...
    Server.prototype.listen = function(httpPort, connectionPort) {
      net.createServer(this._onClient).listen(connectionPort || (connectionPort = 9526));
      net.createServer(this._onHttpClient).listen(httpPort);
      return console.log("listening on http port " + httpPort + " and connection port " + connectionPort);
    };
